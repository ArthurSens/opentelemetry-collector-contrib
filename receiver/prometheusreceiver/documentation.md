...
| `receiver.prometheusreceiver.UseScopeAttributeLabels` | alpha | When enabled, scope attributes are read from `otel_scope_<attribute-name>` labels and `otel_scope_info` is ignored. | v0.147.0 | N/A | [Link](https://github.com/open-telemetry/opentelemetry-collector-contrib/issues/41502) |
